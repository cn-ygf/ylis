...
std::unique_ptr<ui::ImageInfo>
SvgUtil::LoadSvg(const std::wstring &strImageFullPath) {
	std::string strOut;
...
std::unique_ptr<ui::ImageInfo>
SvgUtil::LoadSvg(HGLOBAL hGlobal, const std::wstring &strImageFullPath) {
	if (hGlobal == NULL)
		return nullptr;
...
std::unique_ptr<ui::ImageInfo>
SvgUtil::LoadImageBySvg(void *data, const std::wstring &strImageFullPath) {
